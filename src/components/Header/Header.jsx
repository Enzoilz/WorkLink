            ...
            <header className="grid grid-cols-1 min-h-11 md:min-h-14 bg-background dark:bg-background shadow-2xl shadow-ring">
                <div className="flex justify-between md:justify-around items-center">
                    ...
                    <div className="hidden md:flex md:gap-2 md:pr-2">
                        <motion.button className="w-24 h-7 bg-primary rounded-[0.5rem] text-primary-foreground cursor-pointer" whileHover={{ scale: 1.1, transition: 0.1 }} transition={{ duration: 0.5 }} onClick={handleLogin}>Login</motion.button>
                        <motion.button className="w-24 h-7 bg-primary rounded-[0.5rem] text-primary-foreground cursor-pointer" whileHover={{ scale: 1.1, transition: 0.1 }} transition={{ duration: 0.5 }} onClick={handleRegister}>Register</motion.button>
                    </div>
            ...
            { isOpen && <main className="h-screen">
                <motion.div className="h-full w-full bg-card flex flex-col justify-around items-center" initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }}>
                    ...
                    <div className="flex justify-center flex-col gap-2">
                        <button className="w-48 h-7 bg-primary rounded-[0.5rem] text-primary-foreground cursor-pointer" onClick={handleLogin}>Login</button>
                        <button className="w-48 h-7 bg-primary rounded-[0.5rem] text-primary-foreground cursor-pointer" onClick={handleRegister}>Register</button>
                    </div>
                </motion.div>
            </main> }
        </div>
